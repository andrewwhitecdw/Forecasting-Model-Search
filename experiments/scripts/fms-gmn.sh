...
python fms.py --park simple_cnn_park
python fms.py --ablate-cnn
...
python fms.py --park pretrained_model_park_transfer_svhn
python fms.py --park simple_cnn_park_transfer
